...
exports.onCreateNode = ({ node, actions, getNode, createNodeId}, options) => {
  ...
  // Treat 'index.mdx' as index.html (i.e docs, not docs.index)
...
// custom resolved to add body to the mdx node, because MDX body is not available at time of actions.createNode
    ...
    DocsPage: {
      body: {
        ...
        resolve: (source, args, context, info) => {
          // Load the resolver for the 'MDX' type, specifically the body field
